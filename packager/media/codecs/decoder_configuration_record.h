...
#ifndef MEDIA_CODECS_DECODER_CONFIGURATION_RECORD_H_
#define MEDIA_CODECS_DECODER_CONFIGURATION_RECORD_H_
...
#endif  // MEDIA_CODECS_DECODER_CONFIGURATION_RECORD_H_
